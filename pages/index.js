...
import { CardCreator, Banner, NFTCard } from '../components';
...
const Home = () => {
  ...
  const handleScroll = (direction) => {
    ...
    const scrollAmount = window.innerWidth > 1800 ? 270 : 220;
  ...
  // flexBetween in line 86
  return (
    <div className="flex justify-center sm:px-4 p-12">
      <div className="relative w-full minmd:w-4/5 ">

        <Banner name="Discover, collect, and sell extraordinary NFTs" childStyles="md:text-4xl sm:text-2xl xs:text-xl text-left text-white" parentStyles="justify-start mb-6 h-72 sm:h-60 p-12 xs:p-4 xs:h-44 rounded-3xl" />
        ...
        <div className="mt-10">
          ...
          <div className="mt-3 w-full flex flex-wrap justify-start mid:justify-center ">
