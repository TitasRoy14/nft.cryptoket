...
const FooterLinks = ({ heading, items }) => (
  <div className="flex-1 justify-start items-start">
    <h3 className="font-poppins dark:text-white text-nft-black-1 font-semibold text-lg mb-8">
      {heading}
    </h3>
    ...
    <footer className="flexCenter flex-col dark:border-nft-black-1 border-nft-gray-1 sm:py-8 py-8">
      <div className="w-full minmd:w-4/5 flex flex-row md:flex-col mt-5 border-t  sm:px-4 px-16">
        <div className="flexStart flex-1 flex-col">
          ...
          <p className=" font-poppins dark:text-white text-nft-black-1 font-medium text-base mt-6 ">
      ...
      <div className="flex-center w-full mt-5 border-t dark:border-nft-black-1 border-nft-gray-1 sm:px-4 px-16">
        <div className=" flexBetween flex-row w-full minmd:w-4/5 sm:flex-col mt-7">
          <p className=" font-poppins dark:text-white text-nft-black-1 font-semibold text-base">
            CryptoEth, Inc. All Rights Reserved
          </p>
