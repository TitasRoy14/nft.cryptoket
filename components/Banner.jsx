const Banner = ({ name, childStyles, parentStyles }) => (
  <div
    className={`relative w-full flex items-center z-0 overflow-hidden bg-gradient-to-r from-blue-800 to-cyan-800 ... ${parentStyles}`}
  >
    <p className={`font-bold text-4xl font-poppins leading-70 ${childStyles}`}>
      {' '}
      {name}
    </p>
